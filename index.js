...
bot.on("guildAuditLogs", member => {
    member_ban_add.guild.actionType.find("name", "aéroport").send(`Sa ne doit pas être une grosse perte, ${member} viens de se faire bannir du serveur de la Nelyx - Team ; il n'avais surrement pas lu le <#431231993267879946>`);
});
